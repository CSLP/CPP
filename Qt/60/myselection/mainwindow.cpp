...
{
    ui->setupUi(this);
    ui->mainToolBar->addAction(tr("Current Item"),this,&MainWindow::getCurrentItemData);
    ui->mainToolBar->addAction(tr("toggle Seletction"),this,&MainWindow::toggleSelection);
    ...
    tableView2->show();
    connect(selectionModel,&QItemSelectionModel::selectionChanged,this,&MainWindow::updateSeletcion);
...
{
    qDebug()<<tr("The content of Current Item")<<tableView->selectionModel()->currentIndex().data().toString();
}
...
void MainWindow::updateSeletcion(const QItemSelection &selected, const QItemSelection &deselected)
{
    QModelIndex index;
