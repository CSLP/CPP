...
struct qt_meta_stringdata_MyClock_t {
    QByteArrayData data[1];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MyClock_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyClock_t qt_meta_stringdata_MyClock = {
    {
QT_MOC_LITERAL(0, 0, 7) // "MyClock"
...
const QMetaObject MyClock::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MyClock.data,
      qt_meta_data_MyClock,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyClock::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyClock.stringdata0))
