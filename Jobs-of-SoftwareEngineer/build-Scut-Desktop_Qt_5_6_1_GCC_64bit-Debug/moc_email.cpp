...
QT_MOC_LITERAL(1, 6, 2), // "re"
QT_MOC_LITERAL(2, 9, 0), // ""
QT_MOC_LITERAL(3, 10, 3) // "des"
...
void email::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->re((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->des(); break;
        default: ;
        }
        ...
        {
            typedef void (email::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&email::re)) {
                *result = 0;
                return;
            }
        }
