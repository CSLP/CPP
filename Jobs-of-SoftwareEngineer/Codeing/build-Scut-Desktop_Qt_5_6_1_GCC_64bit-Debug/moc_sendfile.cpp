...
QT_MOC_LITERAL(1, 9, 25), // "on_openPushButton_clicked"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 27), // "on_cancelPushButton_clicked"
QT_MOC_LITERAL(4, 64, 27) // "on_submitPushButton_clicked"

    },
    "SendFile\0on_openPushButton_clicked\0\0"
...
const QMetaObject SendFile::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SendFile.data,
      qt_meta_data_SendFile,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SendFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SendFile.stringdata0))
        return static_cast<void*>(const_cast< SendFile*>(this));
